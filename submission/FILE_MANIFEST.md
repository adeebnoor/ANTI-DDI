...
- `manuscript/SCIENCE_MANUSCRIPT_v0.7_PRE_SUBMISSION.md` — current main-text source.
- `submission/SCIENCE_SUPPLEMENTARY_MATERIALS.md` — current Supplementary source.
- `submission/SCIENCE_COVER_LETTER.md` — current cover-letter source.
...
- `submission/generated/Science_Research_Article_PRE_SUBMISSION.docx`
- `submission/generated/Science_Supplementary_Materials_PRE_SUBMISSION.docx`
- `submission/generated/Science_Cover_Letter.docx`
