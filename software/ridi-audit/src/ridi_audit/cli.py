...
def main() -> None:
    ...
    c.add_argument("--r0", required=True); c.add_argument("--r1", required=True)
    c.add_argument("--id-col", default="id"); c.add_argument("--score-col", default="score")
    ...
    res = audit_scores(m[args.id_col].astype(str).to_numpy(), m.score_r0.to_numpy(), m.score_r1.to_numpy(), args.k)
