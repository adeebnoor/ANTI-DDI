...
7. **Check the margin certificate when score vectors are comparable.** Report γ_k, ε and whether γ_k > 2ε certifies stability. Once the paired score vectors have been stored, this certificate requires no model retraining or additional inference.
