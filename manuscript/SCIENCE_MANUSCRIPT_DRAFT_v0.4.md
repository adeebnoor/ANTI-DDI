...
**Draft status:** v0.4 — Science-style narrative draft; not submission-ready  
**Target:** Science (AAAS flagship)  
**Submission rule:** do not send until the independent non-PPI external-validation gate, contemporary-model challenge, and prospective-yield uncertainty analyses are complete.  
...
Biomedical artificial intelligence increasingly prioritizes molecular interactions, disease mechanisms and therapeutic hypotheses for experimental follow-up, making model selection a scientific decision rather than a purely computational one. Yet models are commonly selected using benchmarks in which observed relations are contrasted with sampled unknown pairs, a design that can encode structural opportunity independently of pair-specific biology. **Here we show that benchmark design can redirect which biomedical AI model is selected and, consequently, which biological hypotheses are prioritized.** Across drug–target, protein–protein, drug–disease and disease–gene relations, a degree-only predictor showed strong discrimination under conventional evaluation and lost most of it after structural matching. Learned models were affected unequally, reversing the apparent winner in drug–target and disease–gene prediction while leaving a compound–disease control unchanged. In drug–target prediction, five-fit ensembles selected under conventional versus structure-neutralized evaluation disagreed on every top-100 hypothesis, whereas leave-one-initialization-out ensemble turnover was only 0.085 and 0.042. In an independent protein–protein network, three-fit NeuralMF and SVD ensembles disagreed on 99.0% of their top-100 hypotheses while within-family leave-one-out turnover was 13.7% and 5.0%. The same historical protein–protein experiment then linked model selection to later evidence: when both models ranked the identical 70,041,100 previously unobserved human protein pairs, the structure-neutralized-selected SVD recovered 522 of 5,635 relations added in a later BioGRID release within its top 50,000, compared with 181 for the conventionally selected NeuralMF. Benchmark construction can therefore alter model identity, hypothesis identity and later evidence recovery, making benchmark design part of the scientific decision process in biomedical AI.
...
Biomedical AI benchmarks are often treated as passive measuring instruments. Our results instead show that benchmark construction can become part of the scientific decision process. Structural opportunity alone was strongly predictive under conventional evaluation across four relation families. Learned models depended on that opportunity to different extents, sometimes reversing the model selected as best. In two independent relation settings, DTI and PPI, stability-controlled ensembles showed that those selection reversals redirected almost all top-ranked biological hypotheses by substantially more than ordinary initialization noise. Disease–gene prediction showed the same direction after ensembling but also exposed a single-fit instability boundary. In the historical PPI experiment, the model selected after structural neutralization recovered markedly more relations that acquired support in a later BioGRID release, even though every model ranked the same complete historical unknown-pair universe.
...
**Supported now:** benchmark structure can alter apparent performance and model ranking across multiple biomedical relation families; DTI and PPI provide strong, ensemble/stability-controlled evidence that winner reversals redirect hypothesis identity; disease–gene provides supportive ensemble evidence with an explicit single-fit instability boundary; in one non-circular PPI historical experiment, the structure-neutralized-selected model recovered substantially more later-supported relations from the identical complete candidate universe.
